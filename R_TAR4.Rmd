...
sido_shp <- read_sf("../data/bnd_sido_00_2023_2Q/bnd_sido_00_2023_2Q.shp", options = "ENCODING=CP949")
sgg_shp <- read_sf("../data/bnd_sigungu_00_2023_2Q/bnd_sigungu_00_2023_2Q.shp", options = "ENCODING=CP949")
```
